...
test.describe('Product browsing flow', () => {
  test('products listing shows cards and navigating to a detail page works', async ({ page }) => {
...
test.describe('Search flow', () => {
  test('search page loads, accepts input, and shows a valid response', async ({ page }) => {
...
test.describe('Navigation flow', () => {
  test('header nav links navigate to key pages without crashing', async ({ page }) => {
  ...
  test('footer links are present and navigate without crashing', async ({ page }) => {
    await page.goto('/', { waitUntil: 'domcontentloaded' });
    await assertHealthy(page);
...
test.describe('Cart flow', () => {
  ...
  test('add a product to cart and verify cart reflects the item', async ({ page }) => {
