...
Understand how Magic Checkout works on mobile and desktop for logged-in, logged-out and new customers with QuickBuy and One Page features.
...
## [Mobile](https://razorpay.com/docs/payments/magic-checkout/how-it-works/\#mobile)
...
This results in a faster, more efficient checkout experience that boosts conversion rates and enhances satisfaction for both customers and businesses. Know more about

[Quickbuy](https://razorpay.com/docs/payments/payment-gateway/features/quickbuy/)

.

QuickBuy is ideal for returning customers who are logged into Razorpay Checkout and making repeat purchases.

![QuickBuy on Magic Checkout](https://razorpay.com/docs/build/browser/assets/images/quickbuy-magic.jpg)
...
![Magic Checkout Flow on Mobile: Logged out customers](https://razorpay.com/docs/build/browser/assets/images/magic-checkout-flow-logged-out.gif)
...
![Magic Checkout Flow on Mobile: New customers](https://razorpay.com/docs/build/browser/assets/images/magic-checkout-flow-mobile-new-user.gif)
...
## [Desktop](https://razorpay.com/docs/payments/magic-checkout/how-it-works/\#desktop)
...
![Magic Checkout Flow on Desktop: Logged in customers](https://razorpay.com/docs/build/browser/assets/images/magic-checkout-flow-desktop.gif)
...
![Magic Checkout Flow on Desktop: Logged out customers](https://razorpay.com/docs/build/browser/assets/images/magic-checkout-flow-desktop-logged-out.gif)
...
![Magic Checkout Flow on Desktop: New customers](https://razorpay.com/docs/build/browser/assets/images/magic-checkout-flow-desktop-new-user.gif)
