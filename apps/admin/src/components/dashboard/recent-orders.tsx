          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-light-gray">
                <th className="text-left px-5 py-2.5 font-medium text-medium-gray text-xs">Order</th>
                <th className="text-left px-5 py-2.5 font-medium text-medium-gray text-xs">Customer</th>
                <th className="text-right px-5 py-2.5 font-medium text-medium-gray text-xs">Total</th>
                <th className="text-left px-5 py-2.5 font-medium text-medium-gray text-xs">Status</th>
                <th className="text-right px-5 py-2.5 font-medium text-medium-gray text-xs">Date</th>
              </tr>
            </thead>
            <tbody>
