    ...
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-medium-gray mt-0.5">Manage tax rates and GST configuration</p>
        </div>
      ...
      <Card>
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-charcoal">Tax settings</h3>
          </div>
      ...
      <Card>
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-charcoal">GST configuration</h3>
          </div>
          ...
          <Input
            ...
            value={hsnCode}
            onChange={(e) => {
              setHsnCode(e.target.value.replace(/\D/g, ''));
          ...
          <div className="flex items-start gap-2 p-3 bg-off-white rounded-lg">
            ...
            <span className="text-xs text-dark-gray">
              GST rates for clothing: Items up to &#8377;1000 attract 5% GST, above &#8377;1000
              attract 12% GST
            </span>
          </div>
        </div>
      ...
      <Card>
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-charcoal">Tax regions</h3>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-off-white">
                  <th className="text-left px-4 py-2.5 font-medium text-dark-gray">Region</th>
                  <th className="text-left px-4 py-2.5 font-medium text-dark-gray">Tax type</th>
                  <th className="text-left px-4 py-2.5 font-medium text-dark-gray">Rate</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-t border-light-gray">
                  <td className="px-4 py-3 text-charcoal font-medium">India</td>
                  <td className="px-4 py-3 text-dark-gray">GST</td>
                  <td className="px-4 py-3 text-dark-gray">
                    <div className="space-y-1">
                      <p>
                        5% <span className="text-medium-gray">(items &#8806;&#8377;1000)</span>
                      </p>
                      <p>
                        12% <span className="text-medium-gray">(items &gt;&#8377;1000)</span>
                      </p>
                    </div>
                  </td>
                </tr>
          ...
          <div className="flex items-start gap-2 p-3 bg-off-white rounded-lg">
            <CheckCircle size={14} className="text-forest-green mt-0.5 flex-shrink-0" />
            <span className="text-xs text-dark-gray">
              Inter-state (IGST) and intra-state (CGST+SGST) are handled automatically based on
              customer address
            </span>
          </div>
        </div>
      ...
      <Card>
        <div className="space-y-5">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-charcoal">Tax documents</h3>
          </div>
