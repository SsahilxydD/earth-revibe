...
import { stageItem, stageContainer, tapFeedback } from '@/lib/motion';
import { TopBar, SubmittedPill } from '@/components/shell/TopBar';
import { ArrowRight } from '@/components/shell/StepArrow';

export function Submitted() {
  const id = useFlow((s) => s.data.applicationId);
  const applicationId = id ?? 'ER-2026-1842';
