...
import { verifyWhatsAppCode, sendWhatsAppCode } from '@/lib/apply/auth';
import { ScreenShell } from '@/app/(apply)/apply-for-trip-form/_components/shell/ScreenShell';
import { GatePill } from '@/app/(apply)/apply-for-trip-form/_components/shell/TopBar';
import { Eyebrow } from '@/app/(apply)/apply-for-trip-form/_components/shell/Eyebrow';
import {
  ArrowRight,
  ArrowLeft,
} from '@/app/(apply)/apply-for-trip-form/_components/shell/StepArrow';
