...
export const adminNotificationController = {
  async getNotifications(_req: Request, res: Response) {
    ...
    const [newOrderCount, lowStockCount, outOfStockCount, failedPaymentCount, pendingSupportCount] =
      await Promise.all([
  ...
  async getNotificationCount(_req: Request, res: Response) {
    ...
    const [newOrderCount, outOfStockCount, failedPaymentCount] = await Promise.all([
