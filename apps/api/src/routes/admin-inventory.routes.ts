...
router.put("/bulk", validate({ body: bulkUpdateStockSchema }), asyncHandler(adminInventoryController.bulkUpdateStock));
router.put("/:variantId/stock", validate({ body: updateStockSchema }), asyncHandler(adminInventoryController.updateStock));
router.post("/:variantId/adjust", validate({ body: adjustStockSchema }), asyncHandler(adminInventoryController.adjustStock));
