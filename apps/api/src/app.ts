...
import { returnRouter, adminReturnRouter } from './routes/return.routes';
...
import { adminExpenseRouter } from './routes/admin-expense.routes';
...
app.use('/api/v1/admin/returns', adminReturnRouter);
...
app.use('/api/v1/admin/expenses', adminExpenseRouter);
