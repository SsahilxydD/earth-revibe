...
export const createProductSchema = z.object({
  ...
  colorPattern: z.string().optional(),
  fabric: z.string().optional(),
  neckline: z.string().optional(),
  outerwearFeatures: z.string().optional(),
  pantsLengthType: z.string().optional(),
  sleeveLengthType: z.string().optional(),
  targetGender: z.string().optional(),
  topLengthType: z.string().optional(),
  waistRise: z.string().optional(),
